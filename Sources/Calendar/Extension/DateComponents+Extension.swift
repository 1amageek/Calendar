...
public extension Foundation.Calendar.Component {
    ...
    var timeInterval: Double? {
        switch self {
            case .era:          return nil
            case .year:         return (Foundation.Calendar.Component.day.timeInterval! * 365.0)
            case .month:        return (Foundation.Calendar.Component.minute.timeInterval! * 43800)
            case .day:          return 86400
            case .hour:         return 3600
            case .minute:       return 60
            case .second:       return 1
            case .quarter:      return (Foundation.Calendar.Component.day.timeInterval! * 91.25)
            case .weekOfMonth, .weekOfYear: return (Foundation.Calendar.Component.day.timeInterval! * 7)
...
public extension DateComponents {
    ...
    static var allComponentsSet: Set<Foundation.Calendar.Component> {
    ...
    internal static let allComponents: [Foundation.Calendar.Component] =  [.nanosecond, .second, .minute, .hour,
    ...
    internal func toDict() -> [Foundation.Calendar.Component: Int] {
        var list: [Foundation.Calendar.Component: Int] = [:]
    ...
    internal mutating func alterComponents(_ components: [Foundation.Calendar.Component: Int?]) {
        components.forEach {
            if let v = $0.value {
    ...
    subscript(component: Foundation.Calendar.Component) -> Int? {
        switch component {
            case .era:                     return era
