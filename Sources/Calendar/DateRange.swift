...
public struct DateRange {
    ...
    public init(_ date: Date = Date(), range: Range<Int>, component: Component = .day) {
        ...
        switch component {
            ...
            case .weekOfYear: dateComponents = calendar.dateComponents([.yearForWeekOfYear, .weekOfYear], from: date)
            case .weekOfMonth: dateComponents = calendar.dateComponents([.yearForWeekOfYear, .weekOfYear, .weekOfMonth], from: date)
        }
